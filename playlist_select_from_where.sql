...
-- usando case when e tb aplicações de exemplos
...
select
	...
	-- aqui poderia ter usado tambem when..... mas o else pega o restante, que na prática é o mesmo.
	end as Nomegrupo, 
	-- add mais um case, 1 case gera penas 1 coluna n importa quantos when tenham dentro, se quiser outra coluna criar outro case
	case 
...
-- resolvendo exercicio de cima sozinha
--9) listar toda sas transacoes add uma coluna nova sinalizando "alto" "medio" "baixo" para o valor dos pontos (<10, <500, >= 500)
-- intervalos 
-- <= 10 é baixo
-- > 10 e >= 500 é baixo
